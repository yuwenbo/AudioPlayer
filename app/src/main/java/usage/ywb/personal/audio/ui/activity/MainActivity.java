...
import usage.ywb.personal.audio.ui.fragment.AudioLyricFragment;
import usage.ywb.personal.audio.ui.fragment.AudioOtherFragment;
import usage.ywb.personal.audio.ui.adapter.AudioPagerAdapter;
import usage.ywb.personal.audio.ui.fragment.AudiosListFragment;
import usage.ywb.personal.audio.utils.Constants;
import usage.ywb.personal.audio.utils.StatusBar;
import usage.ywb.personal.audio.view.MarqueeTextView;
import usage.ywb.personal.audio.service.AudioService;

import usage.ywb.personal.audio.dao.AudioData;
...
public class MainActivity extends AppCompatActivity implements OnClickListener,
     ...
     * 歌词播放页
     */
    private AudioLyricFragment fragmentLyric;
    /**
     * 其他
     */
    private AudioOtherFragment fragmentOther;
    ...
    private void initViewPager() {
        ...
        fragmentLyric = new AudioLyricFragment();
        fragmentOther = new AudioOtherFragment();
        fragments = new ArrayList<Fragment>();
        fragments.add(fragmentLists);
        fragments.add(fragmentLyric);
...
//        intent.setAction(Constants.MUSIC_SERVICE);
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    ...
                    default:
                        ...
                        fragmentLyric.syncLyric(progress);
                        break;
                }
            }
        };
        serviceConnection = new ServiceConnection() {
            ...
            public void onServiceConnected(final ComponentName name, final IBinder service) {
                ...
                fragmentLyric.initVisualizer(mediaPlayer);
                fragmentLyric.initLyric(entity);
            }
